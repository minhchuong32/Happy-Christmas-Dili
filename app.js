...
$(document).ready(function () {
    ...
    let textTitle = "Gửi vi!";
    let charArrTitle = textTitle.split("");
    let text =  "Merry Christmas Banh Hat De Nuong! 🎄✨ Giáng sinh này, hãy dành thời gian để thư giãn và tận hưởng không khí an lành, ấm áp bên những người thân yêu. Hy vọng mùa lễ hội sẽ mang đến cho vi thật nhiều niềm vui, hạnh phúc và tiếp thêm động lực cho những mục tiêu sắp tới. Chúc vi một Giáng sinh tràn đầy yêu thương và một năm mới thành công rực rỡ ^^ 🎅❤️";
